...
const router = express.Router();          // import router class from express
...
router.get("/", function(req, res){     // router.get = route handling for when someone sends a get request for your browser URL
          ...
          res.render("pages/home-page/home-page");          // renders the HTML file home-page.ejs as a response (res) to the client's web browser
}); 
